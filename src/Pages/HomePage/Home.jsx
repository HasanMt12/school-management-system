    ...
    <div className="w-full">
        ...
        <div className="mt-5 pb-2">
            <form action="">
                ...
                <div className="my-6">
                    <Link to="/dashboard"><button type="submit" className="w-full rounded-md bg-[#457B9D] px-3 py-4 text-white focus:bg-[#8b9fb4] focus:outline-none">Sign in</button></Link>
                </div>
